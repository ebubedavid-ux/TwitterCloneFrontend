  ...
  return (
    <div className="min-h-screen w-screen flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-6">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold mb-3 text-black">Happening now.</h1>
          <p className="text-xl md:text-2xl mb-2 font-semibold text-black">Sign up</p>

          <input
            type="text"
            placeholder="Name"
            className="border w-full border-gray-900 p-2 rounded-3xl bg-transparent text-black transition-all duration-100 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
            value={name}
          ...
          {/* Upload box */}
          <div>
            <div className="flex w-full p-1 text-black border border-gray-900 rounded-3xl items-center gap-2">
              <button
                type="button"
          ...
          <input
            ...
            className="border w-full text-black mb-3 border-gray-900 p-2 rounded-3xl bg-transparent transition-all duration-100 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
            value={password}
          ...
          <button
            type="submit"
            disabled={loading}
            className={`bg-blue-500 w-full focus:outline-none focus:ring-0 text-white py-2 rounded-3xl hover:bg-blue-600 transition ${
          ...
          <p className="text-sm p-3 text-black text-center">
